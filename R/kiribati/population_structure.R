...
persons_ps_isl <- PP_KIR20 |> 
  group_by(islandID, sex) |> 
  summarise(totpop = n())

persons_ps_isl <- as.data.table(persons_ps_isl)

persons_ps_isl_cube <- cube(persons_ps_isl, j = round(sum(totpop),0), by = c("islandID", "sex"), id = FALSE)

persons_ps_isl_cube <- persons_ps_isl_cube |>
  mutate(
    islandID = ifelse(is.na(islandID), "KI", islandID),
    SEX = ifelse(is.na(sex), "_T", sex),
    INDICATOR = "PPCNT", UNIT_MEASURE = "N") |>
  rename(GEO_PICT = islandID, OBS_VALUE = V1)

persons_ps_cube <- persons_ps_isl_cube  #rbind(persons_ps_div_cube, persons_ps_isl_cube)
...
persons_ps_5plus_isl_cube <- cube(persons_ps_5plus_isl, j = round(sum(totpop),0), by = c("islandID", "sex"), id = FALSE)
...
persons_ps_5plus_cube <- persons_ps_5plus_isl_cube #rbind(persons_ps_5plus_div_cube, persons_ps_5plus_isl_cube)
...
persons_ps_12plus_isl_cube <- cube(persons_ps_12plus_isl, j = round(sum(totpop),0), by = c("islandID", "sex"), id = FALSE)
...
persons_ps_12plus_cube <- persons_ps_12plus_isl_cube #rbind(persons_ps_12plus_div_cube, persons_ps_12plus_isl_cube)
...
persons_ps_18plus_isl_cube <- cube(persons_ps_18plus_isl, j = round(sum(totpop),0), by = c("islandID", "sex"), id = FALSE)
...
persons_ps_18plus_cube <- persons_ps_18plus_isl_cube #rbind(persons_ps_18plus_div_cube, persons_ps_18plus_isl_cube)
...
persons_ps_65plus_isl_cube <- cube(persons_ps_65plus_isl, j = round(sum(totpop),0), by = c("islandID", "sex"), id = FALSE)
...
persons_ps_65plus_cube <- persons_ps_65plus_isl_cube #rbind(persons_ps_65plus_div_cube, persons_ps_65plus_isl_cube)
...
persons_ps_15less_isl_cube <- cube(persons_ps_15less_isl, j = round(sum(totpop),0), by = c("islandID", "sex"), id = FALSE)
...
persons_ps_15less_cube <- persons_ps_15less_isl_cube # rbind(persons_ps_15less_div_cube, persons_ps_15less_isl_cube)
...
persons_ps_15TO24_isl_cube <- cube(persons_ps_15TO24_isl, j = round(sum(totpop),0), by = c("islandID", "sex"), id = FALSE)
...
persons_ps_15TO24_cube <- persons_ps_15TO24_isl_cube #rbind(persons_ps_15TO24_div_cube, persons_ps_15TO24_isl_cube)
...
persons_ps_15TO59_isl_cube <- cube(persons_ps_15TO59_isl, j = round(sum(totpop),0), by = c("islandID", "sex"), id = FALSE)
...
persons_ps_15TO59_cube <- persons_ps_15TO59_isl_cube #rbind(persons_ps_15TO59_div_cube, persons_ps_15TO59_isl_cube)
...
persons_ps_15TO64_isl_cube <- cube(persons_ps_15TO64_isl, j = round(sum(totpop),0), by = c("islandID", "sex"), id = FALSE)
...
persons_ps_15TO64_cube <- persons_ps_15TO64_isl_cube #rbind(persons_ps_15TO64_div_cube, persons_ps_15TO64_isl_cube)
...
persons_ps_25TO59_isl_cube <- cube(persons_ps_25TO59_isl, j = round(sum(totpop),0), by = c("islandID", "sex"), id = FALSE)
...
persons_ps_25TO59_cube <- persons_ps_25TO59_isl_cube #rbind(persons_ps_25TO59_div_cube, persons_ps_25TO59_isl_cube)
...
persons_ps_60PLUSS_isl_cube <- cube(persons_ps_60PLUSS_isl, j = round(sum(totpop),0), by = c("islandID", "sex"), id = FALSE)
...
persons_ps_60PLUSS_cube <-  persons_ps_60PLUSS_isl_cube #rbind(persons_ps_60PLUSS_div_cube, persons_ps_60PLUSS_isl_cube)
...
persons_ps_medAge_isl_cube <- cube(persons_ps_medAge_isl, j = round(median(medAge),0), by = c("islandID", "sex"), id = FALSE)
...
persons_ps_medAge_cube <- persons_ps_medAge_isl_cube #rbind(persons_ps_medAge_div_cube, persons_ps_medAge_isl_cube)
...
dependRatio_isl <- dependRatio_isl |>
  select(islandID, sex, Dratio)

dependRatio_isl <- as.data.table(dependRatio_isl)

dependRatio_isl_cube <- cube(dependRatio_isl, j = round(mean(Dratio),0), by = c("islandID", "sex"), id = FALSE)
...
dependRatio1564_cube <- dependRatio_isl_cube #rbind(dependRatio_div_cube, dependRatio_isl_cube)
...
dependRatio1559_cube <- dependRatio_isl_cube #rbind(dependRatio_div_cube, dependRatio_isl_cube)
...
sexRatio_isl <- sexRatio_isl |>
  select(islandID, sex, Sratio)

sexRatio_isl <- as.data.table(sexRatio_isl)

sexRatio_isl_cube <- cube(sexRatio_isl, j = round(mean(Sratio),0), by = c("islandID", "sex"), id = FALSE)
...
sexRatio_cube <-  sexRatio_isl_cube #rbind(sexRatio_div_cube, sexRatio_isl_cube)

#Proportion of children age less than 15 years old

persons_ps_15less_cube_prop <- persons_ps_15less_cube |>
  select(GEO_PICT, SEX, OBS_VALUE) |>
...
persons_ps_childProb_cube <- persons_ps_15less_cube_prop |>
  select(GEO_PICT, SEX, childProp) |>
  rename(OBS_VALUE = childProp) |>
  mutate(sex = SEX, INDICATOR = "POPCHILD", UNIT_MEASURE = "PERCENT")
...
persons_ps_60PLUSSProb_cube <- persons_ps_60PLUSS_cube_prop |>
  select(GEO_PICT, SEX, plus60Prop) |>
  rename(OBS_VALUE = plus60Prop) |>
  mutate(sex = SEX, INDICATOR = "POPELDER60", UNIT_MEASURE = "PERCENT")
...
persons_ps_65PLUSSProb_cube <- persons_ps_65plus_cube_prop |>
  select(GEO_PICT, SEX, plus65Prop) |>
  rename(OBS_VALUE = plus65Prop) |>
  mutate(sex = SEX, INDICATOR = "POPELDER65", UNIT_MEASURE = "PERCENT")
...
persons_ps_youthProp_cube <- persons_ps_15TO24_cube_prop |>
  select(GEO_PICT, SEX, youthProp) |>
  rename(OBS_VALUE = youthProp) |>
  mutate(sex = SEX, INDICATOR = "POPYOUTH", UNIT_MEASURE = "PERCENT")
...
household_isl_cube <- cube(households_isl, j = round(sum(tothh),0), by = c("islandID", "sex"), id = FALSE)
...
households_cube <- household_isl_cube #rbind(households_div_cube, household_isl_cube)
...
households_size_isl <- cube(household_size_isl, j = round(mean(isl_hhSize),1), by = c("islandID", "sex"), id = FALSE)
...
household_size_cube <-  households_size_isl_cube #rbind(household_size_div_cube, households_size_isl_cube)
...
combine_popStructure <- combine_popStructure |>
  select(FREQ, TIME_PERIOD, GEO_PICT, INDICATOR,SEX, OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DATA_SOURCE, OBS_STATUS, OBS_COMMENT, CONF_STATUS)
